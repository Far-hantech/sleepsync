...
const heroStats: { label: string; value: string }[] = [
  { label: "Better Sleep", value: "3hr+" },
  { label: "Energy Boost", value: "85%" },
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-24 text-center md:px-8 lg:px-12">
        ...
        >
          ...
          >
            ...
            SleepSync By Next.js
          </motion.div>

          <motion.h1
            variants={itemVariants}
            className="mb-6 text-4xl font-semibold tracking-tight text-foreground md:text-6xl lg:text-7xl font-serif"
          >
            Reclaim your nights.{" "}
          ...
          >
            Build living habits that respond to your circadian rhythm. Craft
            nightly wind-down rituals, track intuitive streaks, and wake up naturally.
          </motion.p>
